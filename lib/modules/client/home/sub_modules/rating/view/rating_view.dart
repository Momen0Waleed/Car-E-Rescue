          ...
          leading: Padding(
            ...
            child: Consumer<RatingViewModel>(
              builder: (context, vm, _) =>
                  ClientNavigateBackButton(isCompleted: vm.isCompleted),
            ),
          ),
          title: const Text(
            "Rate Service",
        ...
        body: Consumer<RatingViewModel>(
          builder: (context, vm, child) {
            return RefreshIndicator(
              onRefresh: () async {
                await vm.checkStatus(showFeedback: true);
              },
              color: AppColors.red,
                  ...
                  children: [
                    ...
                    TweenAnimationBuilder<double>(
                      ...
                      builder: (context, val, childWidget) {
                        return Opacity(opacity: val, child: childWidget);
                      },
                      child: Container(
                        padding: const EdgeInsets.all(18),
                        decoration: BoxDecoration(
                          color:
                              (vm.isCompleted ? AppColors.green : AppColors.red)
                                  .withOpacity(0.08),
